...
<div class="px-4 py-2 bg-info d-flex gap-1">
    <a class="p-2 text-light text-decoration-none text-capitalize
        ${title == 'SVKB' ? 'bg-light text-dark' : ''}" href="/sinhvienkhaibao"
    ><b>Khai Bao Sinh Vien</b></a>
    <a class="p-2 text-light text-decoration-none text-capitalize
        ${title == 'TKSV' ? 'bg-light text-dark' : ''}" href="/timkiemsinhvien"
    ><b>Tim Kiem Sinh Vien</b></a>
    <a class="p-2 text-light text-decoration-none text-capitalize
        ${title == 'TTVL' ? 'bg-light text-dark' : ''}" href="/thongtinvieclam"
    ><b>Thong Tin Viec Lam</b></a>
